...
export const Search = ({value, setValue}: any) => {

    return (
        <form className="relative w-[630px] flex justify-between items-center py-5">
            <input
                type="text"
                placeholder="Поиск"
                className="pl-7 text-[#B2B7BF] text-sm focus-within:outline-0 bg-[#5A5C66] h-[52px] w-[100%]"
                onChange={(e) => setValue(e.target.value)}
            />
            <div className="absolute pointer-events-auto right-5">
